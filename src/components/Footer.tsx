...
export function Footer() {
  ...
  return (
    <footer className="bg-zinc-50 text-zinc-600 border-t border-zinc-200 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-16 border-b border-zinc-200">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <span className="text-3xl font-black text-black tracking-tighter uppercase" style={{ fontFamily: 'Syne, sans-serif' }}>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="#" aria-label="Instagram" className="size-9 rounded-full bg-white hover:bg-zinc-100 text-black flex items-center justify-center transition border border-zinc-200 shadow-xs">
              ...
              <a href="#" aria-label="X / Twitter" className="size-9 rounded-full bg-white hover:bg-zinc-100 text-black flex items-center justify-center transition border border-zinc-200 shadow-xs">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-black uppercase tracking-widest text-black">Silhouettes</h4>
          ...
          {/* Column: Innovation */}
          <div className="space-y-3">
            <h4 className="text-xs font-black uppercase tracking-widest text-black">Innovation</h4>
            <ul className="space-y-2 text-xs font-medium">
              <li><a href="#tech-lab" className="hover:text-black transition">Carbon Wave Plate</a></li>
              <li><a href="#tech-lab" className="hover:text-black transition">SuperCritical PEBA Foam</a></li>
              ...
              <li><a href="#lookbook" className="hover:text-black transition">Global Street Lookbook</a></li>
            </ul>
          </div>

          {/* Column: Support */}
          <div className="space-y-3">
            <h4 className="text-xs font-black uppercase tracking-widest text-black">Club Care</h4>
            <ul className="space-y-2 text-xs font-medium">
              ...
              <li><a href="#" className="hover:text-black transition">Sneaker Care & Cleaning</a></li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500 font-medium">
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-white hover:bg-zinc-100 text-black font-bold transition border border-zinc-200 shadow-xs cursor-pointer"
          >
